...
RemoteTarget.prototype.prepare = function prepare() {
	Target.prototype.prepare.call(this);
	global.upload = function upload(localPath) {
		var uploadChain = {
			andFinally: function andFinally(cb) {
				this.rc.uploadFile(localPath, cb);
			}.bind(this)
		};
		this.chains.push(uploadChain);
		this.emit('chain', uploadChain);
	}.bind(this);
};

RemoteTarget.prototype.destroy = function destroy() {
